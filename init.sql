...
-- La base rag_db existe déjà via POSTGRES_DB, donc on se connecte directement
\c rag_db
...
-- Donner les permissions sur les tables et séquences
...
-- Par défaut pour les futurs objets
